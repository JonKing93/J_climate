function[T, C] = getTandC(ts_m0, M, algorithm)
...
% ----- Helper Functions -----
function[N] = setup(ts_m0, M)

% Check that Data_m0 is a vector
if ~isvector(ts_m0) || hasNaN(ts_m0)
